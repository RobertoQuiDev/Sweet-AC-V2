SwatCS = { --Laisse
ServerKey = '054235307becb30e2fb7a3c25b36a2ca67f97290', --La key que je tes give
ServerName = "AlphaRP", --Le Nom de ton serv
discord = "discord.gg/alpha", --Le lien de ton discord
Debug = false, --Pour moi xd bref desactive casi tout ac (:
webhook = {
	detect = 'https://discord.com/api/webhooks/898619443419164772/YP-TP7y4saWT2BQ1XcMbeA018M8VKC_5DYVnXoN_L8QBZA-iu7UqYJN_dQDkPKMtfH4S', --webhook discord
	antivpn = 'https://discord.com/api/webhooks/898619443419164772/YP-TP7y4saWT2BQ1XcMbeA018M8VKC_5DYVnXoN_L8QBZA-iu7UqYJN_dQDkPKMtfH4S', --webhook discord
	spawncar = 'https://discord.com/api/webhooks/898619317598453760/tQOHV1hD-vKTlEEFPua5XMGDQr1s2vsHnHS8gYUu6g_s8qWkJY135k11wHI4tdkXh93-', --webhook discord
	touchebl = 'https://discord.com/api/webhooks/898619236837109790/VNJGh9c4_f7k64JmrSCoQuGxBNrzoULDRoCwXjOfciXgbCqaR4lFkNePlO8lJy_Ezbj6', --webhook discord
},

domage = { --Check pour les dega et autre
	on = true, --on veux dire marche
	checkweapon = true,
	multiplier = true,
	killcount = true,
},
GiveWeaponsProtection = { --Give remove et autre
	on = true, --on veux dire marche
	give = true,
	remove = true,
	removeall = true,
},
wlcountrysetting = { --WL les pays que tu veux
	on = true, --on veux dire marche
	--https://www.nationsonline.org/oneworld/country_code_list.htm
	--alpha 2 seulement
	wlcountrys = {
		"FR", "BE", "MC", "GP", "TN", "CA", "CH", "IL", "IT", "DZ", "MA", "DK", "US", "PT", "RE",
	},
},


sql = { --Opti le sql et ades option sql
	on = false,
	--phone opti
	phone_messages_Table = 'phone_messages', -- phone message table
	police = 'police', --nom du job
	ambulance = 'ambulance', --nom du job
	bcso = 'bcso', --nom du job
	mecano = 'mecano', --nom du job
	--Ban Table
	sweetban = 'Sweet_ban', --ban table
},

Maxratelimit = 30, --les maximum de requet au serveur en peux de temo


BaseCalifornia = { -- Des protect de base Calif
	on = false,
	--trigger
	killall = true,
},

blacklistName = { -- Les blacklisted Name
	on = true, --on veux dire marche
	refusemessage = "Veuillez modifier votre nom d'utilisateur pour pouvoir jouer au serveur ", --Message de refus de connection
},

blacklistNameList = { --Nom blacklist
    "%^1",
    "%^2",
    "%^3",
    "%^4",
...
anticlearpedtask = true, --Anti frezze et autre 
...
--BAS TU MET TOUT TES EVENT POUR LES RATELIMIT
Ratelist = {
	...
	"spyke:buyCrate",
	"spykestore:buyItem",
	"spykeanticheat:banCheatVehicle",
	"clotheshop:pay",
	"clotheshop:saveOutfit",
	"clotheshop:deleteOutfit",
	"coffre:getStockItem",
	"driftforscreen",
	"coffre:putStockItems",
	"drivingschool:addLicense",
	"drivingschool:pay",
	"drugs:startHarvest",
	"drugs:stopHarvest",
	"drugs:startTransform",
	"drugs:stopTransform",
	"drugs:startSell",
	"drugs:stopSell",
	"ballasgang:handcuff",
	...
	"holdupbank:toofar",
	"holdupbank:rob",
	"spykerob:houseRobbed",
	"spykerob:callThePolice",
	"spykerob:sync",
	"spykerob:getHousesStates",
	...
	"jailer:UnJailplayer",
	"ambulance:giveItem",
	"ambulance:removeItem",
	"ambulance:setDeathStatus",
	"ambulance:revive",
	"ambulance:healsmall",
	"ambulance:healbig",
	"ambulance:sendCall",
	"ambulance:DeleteCall",
	"spykegouv:announce",
	"kfc:giveEat",
	"jobs:pay",
	"policejob:confiscatePlayerItem",
	"policejob:handcuff",
	"policejob:drag",
	"policejob:putInVehicle",
	"policejob:OutVehicle",
	"policejob:getStockItem",
	"policejob:putStockItems",
	"policejob:spawned",
	"policejob:forceBlib",
	"realestateagentjob:revoke",
	"realestateagentjob:sell",
	"realestateagentjob:rent",
	"tabac:startHarvest",
	"tabac:stopHarvest",
	"tabac:startTransform",
	"tabac:stopTransform",
	"tabac:startSell",
	"tabac:stopSell",
	"unicorn:give",
	"vehicleshop:setVehicleOwned",
	"vehicleshop:setVehicleOwnedPlayerId",
	"vehicleshop:setVehicleOwnedSociety",
	"vehicleshop:sellVehicle",
	"vehicleshop:addToList",
	"vehicleshop:rentVehicle",
	"vehicleshop:getStockItem",
	"vehicleshop:putStockItems",
	"vehicleshop:returnProvider",
	"vehicleshop:setJobVehicleState",
	"vigneron:startHarvest",
	"vigneron:stopHarvest",
	"vigneron:startTransform",
	"vigneron:stopTransform",
	"vigneron:startSell",
	"vigneron:stopSell",
	"mumble:Initialise",
	"mumble:SetVoiceData",
	"truck:getSharedDataStore",
	"society:withdrawMoney",
	"society:depositMoney",
	"society:washMoney",
	"society:quitjob",
	"society:quitorga",
	"skin:save",
	"skin:responseSaveSkin",
	"sit:takePlace",
	"sit:leavePlace",
	"weashop:Giveppa",
	"weashop:buyItem",
	...
	"service:notifyAllInService",
	"narshop:buyItem",
	"narshop:remove",
	"moneywash:startWhitening",
	"moneywash:stopWhitening",
	"vehiclelock:refreshVehiclesOwners",
	"vehiclelock:keyjob",
	"spyke:UpdateCarRadio",
	"spyke:DeleteCarRadio",
	"spyke:InsertCarRadio",
	"txAdmin:menu:sendAnnouncement",
	"spyke:sendLog",
	"discordLogs",
	"fc:onPlayerDeath",
	"playerDied",
	...
	"ClientDiscord",
	"spykelimited:admin",
	"spykelimited:unlimited",
	"handcuff:unrestrain",
	"handcuff:on",
	"handcuff:off",
	"handcuff:drag",
	"handcuff:putInVehicle",
	"handcuff:OutVehicle",
	"spyke:SopenInventory",
	"spyke:updateKey",
	"license:show",
	"lscustom:buyMod",
	"lscustom:refreshOwnedVehicle",
	"spykephone:twitter_login",
	"spykephone:twitter_changePassword",
	"spykephone:twitter_createAccount",
	"spykephone:twitter_getTweets",
	"spykephone:twitter_getFavoriteTweets",
	"spykephone:twitter_postTweets",
	"spykephone:twitter_toogleLikeTweet",
	"spykephone:twitter_setAvatarUrl",
	"spykephone:twitter_newTweets",
	"spykephone:addContact",
	"spykephone:updateContact",
	"spykephone:deleteContact",
	"spykephone:_internalAddMessage",
	"spykephone:sendMessage",
	"spykephone:deleteMessage",
	"spykephone:deleteMessageNumber",
	"spykephone:deleteAllMessage",
	"spykephone:setReadMessageNumber",
	"spykephone:deleteALL",
	"spykephone:getHistoriqueCall",
	"spykephone:register_FixePhone",
	"spykephone:internal_startCall",
	"spykephone:startCall",
	"spykephone:candidates",
	"spykephone:acceptCall",
	"spykephone:rejectCall",
	"spykephone:appelsDeleteHistorique",
	"spykephone:appelsDeleteAllHistorique",
	"spykephone:allUpdate",
	"spykephone:bankTransferByPhoneNumber",
	"spykephone:tchat_channel",
	"spykephone:tchat_addMessage",
	"spykephone:sendMessage",
	"addons_spykephone:startCall",
	"phone:send",
	"spyke:clientLog",
	"spyke:triggerServerCallback",
	"hostingSession",
	"txaLogger:DeathNotice",
	"dmvschool:addLicense",
	"txaLogger:CommandExecuted",
	"txaLogger:DebugMessage",
	"txaLogger:internalChatMessage",
},

AntiVPN = false, --bug sur des gros serveur
BanIP = true, --Desactive si tu utulise des proxy
AntiVPNDiscordLogs = true, --si tu veux des logs dans antivpn
Chatdetect = true, -- si tu veux avoir une notif ig (staff) si que le mec se fait detect
WordsProtection = true, --mot blacklist
ExplosionProtection = true, -- Blacklist explosion
TriggersProtection = true, --Trigger Blaklist
BlacklistedEntityDetection = true, -- Blacklisted entity
antivehculespawn = true, -- Anspawn vechule
MassParticles = 4, --Max de particule (ratelimit)
massfire = 5, --Max fire (Ratelimit)
massVehicles = 5, --Max vehcule (ratelimit)
massPeds = 3, --Max Ped (Ratelimit)
antiprojectil = true, --tire vehcule et autre

BlockedExplosions = { --Explostion BL
    0, --> Grenade
    1, --> Grenade Launcher
    2, --> Sticky Bomb
    3, --> Molotov
...
BlacklistedWords = { --mot blacklist
	'Desudo',
	'Brutan',
	'EulenCheats',
	"lynxmenu",
...
BlacklistedModels = { --Model blacklist
	--VEHICLES
	"skylift",
	"valkyrie2",
	"airbus",
...
--fin des config bravo de t'avoir rendu ici lol
